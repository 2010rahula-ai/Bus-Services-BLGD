...
const navBar = document.getElementById('fullscreen-header');
        let lastTap = 0;
        ...
        function initHolidayGreeting() {
            ...
            // --- 2026 UPDATED HOLIDAY CALENDAR ---

            // Jan 1: New Year
            if (month === 1 && date === 1) {
msg = "Happy New Year 2027!" ;
          emoji = "🎊🎁"; 
              style = "style-christmas";
            }
            // Jan 14: Thai Pongal
            else if (month === 1 && date === 14) {
                msg = "இனிய தைப்பொங்கல் வாழ்த்துக்கள்!";
                emoji = "🌾☀️"; style = "style-hindu";
            }
 // March 15: Maha Shivaratri
            else if (month === 3 && date === 15) {
                msg = "இனிய மஹா சிவராத்திரி வாழ்த்துக்கள்!";
                emoji = "🔱🕉️"; style = "style-hindu";
            }
            // March 21: Eid al-Fitr (Ramazan)
            else if (month === 3 && (date === 20 || date === 21)) {
                msg = "Eid Mubarak! / ஈத் முபாரக்!";
                emoji = "🌙🕌"; style = "style-muslim";
            }
              else if (month === 4 && (date === 1 )) {
                msg = " සුබ උපන් දිනයක් වේවා! / Happy Birthday !";
                emoji = "🎊🎂🍪🎁🥇🌟"; style = "style-christmas";
            }
            // April 13-14: Sinhala & Tamil New Year
            else if (month === 4 && (date === 13 || date === 14)) {
                msg = "සුබ අලුත් අවුරුද්දක් වේවා! <br> இனிய புத்தாண்டு வாழ்த்துகள்!";
                emoji = "🎊🍩🍪🎂🧁🎁"; style = "style-sinhala";
            }

else if (month === 5 && (date === 1 )) {
                msg = " නිදහස් දිනය  | National Day";
                emoji = "🗽🇱🇰 🤝🥁 🎶🎈  🎊"; style = "style-sinhala";
            }
              
            // May 30-31: Vesak Poya
            else if (month === 5 && (date === 30 || date === 31)) {
                msg = "පින්බර වෙසක් මංගල්‍යයක් වේවා!";
                emoji = "🙏☸️🛐🧘🏮🌕🌟🎊"; style = "style-buddhist";
            }
            // June 29: Poson Poya
            else if (month === 6 && date === 29) {
                msg = "පින්බර පොසොන් පෝය දිනයක් වේවා!";
                emoji = "🙏☸️🛐🧘🏮🌕🌟🎊"; style = "style-buddhist";
            }

              else if (month === 7 && (date === 29 || date === 31)) {
                msg = "වස්සාන ආරම්භය. ඇසල පෝය!";
                emoji = "☸️🛐🧘🌕"; style = "style-buddhist";
            }
            // Aug 25: Milad-un-Nabi (Prophet's Birthday)
            else if (month === 8 && date === 25) {
                msg = "Milad-un-Nabi Mubarak!";
                emoji = "🕋🌙"; style = "style-muslim";
            }
            // Nov 8: Deepavali
            else if (month === 11 && date === 8) {
                msg = "இனிய தீபாவளி திருநாள் வாழ்த்துக்கள்!";
                emoji = "🪔✨"; style = "style-hindu";
            }
            // Dec 25: Christmas
            ...
            if (msg !== "") {
                ...
                document.getElementById('h-text').innerHTML = msg;
                document.getElementById('h-emoji').innerText = emoji;
        ...
        window.addEventListener('load', initHolidayGreeting);
